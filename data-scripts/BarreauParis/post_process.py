...
OUT_PP = os.path.join(ROOT, 'output', 'BarreauParis', 'extraction_barreau_paris_pp.csv')
OUT_ST = os.path.join(ROOT, 'output', 'BarreauParis', 'extraction_structures_barreau_paris.csv')
...
def main() -> None:
    ...
    with open(OUT_ST, 'w', encoding='utf-8-sig', newline='') as f:
        writer = csv.DictWriter(f, fieldnames=STRUCT_HEADERS, delimiter=';', extrasaction='ignore')
        writer.writeheader()
