// Nomenclature des Activités Françaises (NAF rév. 2, 2008)
export const NAF_CODES: Record<string, string> = {
  // A — Agriculture, sylviculture et pêche
  "01.11Z": "Culture de céréales (sauf riz), légumineuses, graines oléagineuses",
  ...
  "01.24Z": "Culture de fruits à pépins et à noyaux",
  ...
  "08.99Z": "Autres activités extractives",
  ...
  "10.13B": "Charcuterie",
  "10.20Z": "Transformation et conservation de poisson, crustacés et mollusques",
  ...
  "13.95Z": "Fabrication de non-tissés",
  "13.96Z": "Fabrication d'autres textiles techniques et industriels",
  "13.99Z": "Fabrication d'autres textiles",
  ...
  "16.21Z": "Fabrication de placages et panneaux de bois",
  ...
  "16.29Z": "Fabrication d'objets divers en bois, liège, vannerie et sparterie",
  ...
  "17.29Z": "Fabrication d'autres articles en papier ou carton",
  ...
  "20.13B": "Fabrication d'autres produits chimiques inorganiques de base",
  ...
  "22.29A": "Fabrication de pièces techniques en matières plastiques",
  ...
  "23.61Z": "Fabrication de produits en béton pour la construction",
  "23.62Z": "Fabrication de produits en plâtre pour la construction",
  ...
  "23.69Z": "Fabrication d'autres ouvrages en béton, plâtre ou ciment",
  "23.70Z": "Taille, façonnage et finissage de pierres",
  "23.91Z": "Fabrication de produits abrasifs",
  "23.99Z": "Fabrication d'autres produits minéraux non métalliques",
  "24.10Z": "Sidérurgie",
  "24.20Z": "Fabrication de tubes, tuyaux, profilés creux et accessoires en acier",
  ...
  "24.43Z": "Métallurgie du plomb, du zinc et de l'étain",
  ...
  "25.11Z": "Fabrication de structures métalliques et parties de structures",
  ...
  "25.94Z": "Fabrication de vis et boulons",
  ...
  "26.52Z": "Horlogerie",
  "26.60Z": "Fabrication d'équipements d'irradiation médicale, électromédicaux et électrothérapeutiques",
  ...
  "28.23Z": "Fabrication de machines et d'équipements de bureau (hors ordinateurs et matériel informatique)",
  ...
  "28.29A": "Fabrication d'équipements d'emballage, de remplissage et de conditionnement",
  ...
  "28.93Z": "Fabrication de machines pour l'industrie alimentaire, des boissons et du tabac",
  ...
  "28.96Z": "Fabrication de machines pour le travail du caoutchouc et des plastiques",
  ...
  "43.41Z": "Travaux de peinture extérieure",
  "43.42Z": "Pose de fermetures menuisées extérieures",
  "43.91Z": "Travaux de charpente",
  ...
  "46.15Z": "Intermédiaires du commerce en meubles, articles ménagers et quincaillerie",
  ...
  "46.19A": "Centrale d'achat non alimentaire",
  "46.19B": "Autres intermédiaires du commerce en produits divers",
  "46.21Z": "Commerce de gros de céréales, tabac, semences et aliments pour le bétail",
  ...
  "46.32C": "Commerce de gros de volailles et gibiers",
  "46.33Z": "Commerce de gros de produits laitiers, œufs, huiles et matières grasses",
  ...
  "46.49Z": "Commerce de gros d'autres biens de consommation non alimentaires",
  ...
  "47.76Z": "Commerce de détail de fleurs, plantes, graines, engrais, animaux de compagnie",
  ...
  "47.78B": "Commerce de détail de charbons et combustibles domestiques",
  ...
  "47.82Z": "Commerce de détail de textiles, habillement et chaussures sur éventaires et marchés",
  ...
  "47.99B": "Vente par automates et autres commerces de détail hors magasin, éventaires ou marchés",
  ...
  "64.99Z": "Autres activités des services financiers, hors assurance et caisses de retraite",
  ...
  "66.19B": "Autres auxiliaires financiers",
  ...
  "77.22Z": "Location de cassettes vidéo et disques vidéo",
  ...
  "84.12Z": "Administration publique — santé, formation, culture et autres services sociaux",
  "84.13Z": "Administration publique — activités économiques",
  ...
  "86.22C": "Autres activités spécialisées de médecine",
  ...
  "93.14Z": "Activités des clubs omnisports",
  "93.19A": "Activités des fédérations sportives",
  "93.19B": "Autres activités liées au sport",
  ...
  "94.99Z": "Activités des organisations associatives",
...
export function isNafCode(value: string): boolean {
  return NAF_CODE_PATTERN.test(value.trim());
}

export function nafLabel(code: string | null | undefined): string | null {
  if (!code) return null;
  const trimmed = code.trim();
  return NAF_CODES[trimmed] ?? null;
}

export function nafDisplay(value: string | null | undefined): string | null {
  if (!value) return null;
  if (isNafCode(value)) {
    const label = NAF_CODES[value.trim()];
